...
// vtable. The table itself is in balancer_table.cu.
...
// settings file means.
constexpr const char* kNoBalancer = "none";
...
// The entry `name` selects, or null for kNoBalancer. Fails with the list
...
// Build it. An empty handle for kNoBalancer, which Integrator takes to
